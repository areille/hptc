    ...
    \begin{document}
        ...
        \section{Discussion}
            ...
            \subsection{Step size study}
                ...
                for a small step size. Except for the Forward Space Central Time method \cite{ftcs}, we have a good stability.\\
                So we can say that in this case, parallelizing complex programs leads to a good stability, but still
                with a bigger error than in the same program in serial.\\
            ...
            \subsection{Performance study}
                ...
                of speed could be, as seen before, the fact that our problem is not complex enough to be put in parallel, 
                and the communication time induced by the parallelization decreases the efficiency of our serial algorithms.
